...
#Importing Schemas
from api.v1.schemas.Formats.fo_le_01 import FOLE01UpdateSchema, FOLE01Schema, FOLE01TableRawSchema, FOLE01CreateSchema
...
@FOLE01Router.post("create", response_model=FOLE01Schema)
...
@FOLE01Router.get("get_table/{equipment_id}", response_model=List[FOLE01TableRawSchema])
...
@FOLE01Router.put("update/{fole01_id}", response_model=FOLE01Schema)
