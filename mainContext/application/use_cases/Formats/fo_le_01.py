...
from mainContext.application.dtos.Formats.fo_le_01_dto import FOLE01UpdateDTO, FOLE01TableRawDTO, FOLE01SignatureDTO
...
class CreateFOLE01:
    ...
    def execute(self, dto : FOLE01CreateDTO) -> FOLE01:
...
class UpdateFOLE01:
    ...
    def execute(self, fole01_id: int, dto: FOLE01UpdateDTO) -> FOLE01:
...
class GetListFOLE01Table:
    ...
    def execute(self, equipment_id : int) -> List[FOLE01TableRawDTO]:
...
class SignFOLE01:
    ...
    def execute(self, id: int, dto: FOLE01SignatureDTO):
