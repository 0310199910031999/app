...
from sqlalchemy import BigInteger, Date, DateTime, Float, ForeignKeyConstraint, Integer, PrimaryKeyConstraint, REAL, Sequence, SmallInteger, String, Time, UniqueConstraint, text
...
class FoimQuestions(Base):
    ...
    answer: Mapped[Optional[str]] = mapped_column(String(250))
...
class Employees(Base):
    ...
    fopc02: Mapped[list['Fopc02']] = relationship('Fopc02', foreign_keys='[Fopc02.employee_id]', back_populates='employee')
    fopc02_: Mapped[list['Fopc02']] = relationship('Fopc02', foreign_keys='[Fopc02.equipment_id]', back_populates='equipment')
...
class Equipment(Base):
    ...
    foro05_services: Mapped[list['Foro05Services']] = relationship('Foro05Services', back_populates='equipment')
...
class Fole01(Base):
    ...
    equipment_id: Mapped[Optional[int]] = mapped_column(Integer)
    hourometer: Mapped[Optional[float]] = mapped_column(REAL)
    technical_action: Mapped[Optional[str]] = mapped_column(String(300))
    status: Mapped[Optional[str]] = mapped_column(String(50))
    reception_name: Mapped[Optional[str]] = mapped_column(String(150))
    signature_path: Mapped[Optional[str]] = mapped_column(String(50))
    date_signed: Mapped[Optional[datetime.datetime]] = mapped_column(DateTime)
...
class Fopc02(Base):
    ...
    __table_args__ = (
        ...
        ForeignKeyConstraint(['equipment_id'], ['employees.id'], name='fopc02_equipment_id_fkey'),
    ...
    employee: Mapped[Optional['Employees']] = relationship('Employees', foreign_keys=[employee_id], back_populates='fopc02')
    equipment: Mapped[Optional['Employees']] = relationship('Employees', foreign_keys=[equipment_id], back_populates='fopc02_')
...
class Foos01Services(Base):
    ...
    service_id: Mapped[Optional[int]] = mapped_column(Integer)
    service_description: Mapped[Optional[str]] = mapped_column(String(200))
...
class Foir02EquipmentChecklist(Base):
    ...
    comments: Mapped[Optional[str]] = mapped_column(String(20))
...
class Foro05Services(Base):
    ...
    equipment: Mapped[Optional['Equipment']] = relationship('Equipment', back_populates='foro05_services')
